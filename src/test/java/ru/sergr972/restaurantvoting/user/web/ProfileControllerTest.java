package ru.sergr972.restaurantvoting.user.web;
...
import ru.sergr972.restaurantvoting.user.repository.UserRepository;
import ru.sergr972.restaurantvoting.user.to.UserTo;
import ru.sergr972.restaurantvoting.common.util.JsonUtil;
import ru.sergr972.restaurantvoting.user.UsersUtil;
...
import static ru.sergr972.restaurantvoting.user.web.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(repository.findAll(), admin, guest, guest2, guest3);
    }
