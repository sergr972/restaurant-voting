...
import ru.sergr972.restaurantvoting.restaurant.repository.RestaurantRepository;
...
import static ru.sergr972.restaurantvoting.restaurant.web.AdminRestaurantController.REST_URL;
import static ru.sergr972.restaurantvoting.user.UserTestData.ADMIN_MAIL;
import static ru.sergr972.restaurantvoting.user.UserTestData.NOT_FOUND;
...
class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    void get() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + RESTAURANT_ID))
                ...
                .andExpect(RESTAURANT_TO_MATCHER.contentJson(R_1_TO));
    }
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(RESTAURANT_TO_MATCHER.contentJson(R_3_TO, R_1_TO, R_4_TO, R_2_TO));
    }
