...
public class RestaurantTestData {
    ...
    public static final Restaurant R_2 = new Restaurant(RESTAURANT_ID + 1, "VKUSNO",
            Set.of(new Dish(1, "Dish1", LocalDate.of(2024, 1, 29), 250),
                    new Dish(2, "Dish2", LocalDate.now(), 350),
                    new Dish(3, "Dish3", LocalDate.now(), 450)));

    public static final Restaurant R_3 = new Restaurant(RESTAURANT_ID + 2, "HACHOPURI",
            Set.of(new Dish(1, "Dish1", LocalDate.of(2024, 1, 30), 350),
                    new Dish(2, "Dish2", LocalDate.now(), 450),
                    new Dish(3, "Dish3", LocalDate.now(), 550)));

    public static final Restaurant R_4 = new Restaurant(RESTAURANT_ID + 3, "TOKIO",
            Set.of(new Dish(1, "Dish1", LocalDate.of(2024, 1, 28), 250),
                    new Dish(2, "Dish2", LocalDate.now(), 450),
                    new Dish(3, "Dish3", LocalDate.now(), 650)));
